...
impl Point {
    ...
    ///
    /// # Parameters
    /// - `x`: f64he x-coordinate of the point.
    /// - `y`: f64he y-coordinate of the point.
    ///
    /// # Returns
    ...
    ///
    /// # Parameters
    /// - `other`: f64he other point to calculate the distance to.
    ///
    /// # Returns
...
mod tests {
    ...
    fn test_euclidean_distance_positive_coordinates() {
        ...
        let point1: Point = Point::new(3.0, 4.0);
        let point2: Point = Point::new(6.0, 8.0);
    ...
    fn test_euclidean_distance_negative_coordinates() {
        ...
        let point1: Point = Point::new(-2.0, -3.0);
        let point2: Point = Point::new(-5.0, -7.0);
    ...
    fn test_euclidean_distance_with_zero_coordinate() {
        ...
        let point2: Point = Point::new(3.0, 4.0);
    ...
    fn test_euclidean_distance_far_points() {
        ...
        let point1: Point = Point::new(1000000.0, 1000000.0);
        let point2: Point = Point::new(-1000000.0, -1000000.0);
    ...
    fn test_euclidean_distance_close_coordinates() {
        ...
        let point1: Point = Point::new(0.0, 0.0);
        let point2: Point = Point::new(0.000001, 0.000001);
    ...
    fn test_euclidean_distance_identical_points() {
        let point1: Point = Point::new(0.0, 0.0);
        let point2: Point = Point::new(0.0, 0.0);
        let distance: f64 = point1.euclidean_distance(&point2);
    ...
    fn test_euclidean_distance_different_x_same_y() {
        let point1: Point = Point::new(2.0, 3.0);
        let point2: Point = Point::new(5.0, 3.0);
        let distance: f64 = point1.euclidean_distance(&point2);
    ...
    fn test_euclidean_distance_different_y_coordinates() {
        let point1: Point = Point::new(0.0, 0.0);
        let point2: Point = Point::new(0.0, 1.0);
        let distance: f64 = point1.euclidean_distance(&point2);
